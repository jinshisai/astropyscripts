...
class Imfits():
	'''
	Read and handle a fits file.
	'''


	def __init__(self, infile, pv=False, use='absolute'):
		...
		if pv:
			...
			self.read_header()
			self.fits_deprojection(use=use)
	...
	def fits_deprojection(self, noreg=True, use='relative'):
		'''
